...
@Repository
public interface ReconciliationExceptionRepository extends JpaRepository<ReconciliationException, Long>, JpaSpecificationExecutor<ReconciliationException> {
